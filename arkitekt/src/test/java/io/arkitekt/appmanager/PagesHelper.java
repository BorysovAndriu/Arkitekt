...
public class PagesHelper extends HelperBase{
    ...
    public void toggle(By locatorFind, By toggle, String namePage) throws InterruptedException {
        openSettingPages(locatorFind);
        Thread.sleep(5000);
        click (toggle);
        gotoFrame(By.xpath("//div[3]/iframe[2]"));
        if (! isElementPressent(By.xpath("//nav[5]/div/div[1]/ul/li[1]/a/span"))){
            click(By.xpath("//nav[5]/div/div[1]/ul/li[2]/a/span"));
            stopFrame();}
        else {checkingNavPagesBuilder(namePage, By.xpath("//nav[5]/div/div[1]/ul/li[1]/a/span"));}
    ...
    public void renamePage(By locatorFind, String text, By type, String checkText) throws InterruptedException {
        ...
        Thread.sleep(5000);
        rename(text, type);
        checkingNavPagesBuilder(checkText, By.xpath("//nav[5]/div/div[1]/ul/li[1]/a/span"));
